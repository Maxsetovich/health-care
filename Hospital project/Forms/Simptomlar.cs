...
{
    public partial class Simptomlar : Form
    {
        public Simptomlar()
        {
            InitializeComponent();
        ...
        {
            if (chb1.Checked || chb2.Checked || chb3.Checked || chb4.Checked || chb5.Checked || chb6.Checked || chb7.Checked || chb8.Checked || chb9.Checked)
            {
                this.Close();
            }
